label prolog:
    ...
    elt "Обязываю всех должностных лиц, ответственных за проведение мероприятий по восстановлению в Чеченской Республике конституционного порядка,{w} не применять насилия против мирного населения против мирного населения,{w} взять его под свою защиту."
    ...
    "Я отправился «домой» в ангар.{w} Подходя, увидел, что мои бойцы разгружают вертолет с «грузом-200»."
