...
label argun_survived:
    ...
    om "Как скотину порежу! Потроха вытресу!"
...
label oldman_alive:
    ...
    "Проговорил старик опускаясь на землю."
    gg "Вот так и лежи! И тольео попробуй дёрнуться!"
    om "Бид аудал!"
    #СЦЕНА ХУТОРА
    #ТРЯСКА ЭКРАНА
    "Я выскочил из халупы и побежал к концу деревни, надеясь поскорее скрыться."
    ...
    "Он ответил, что в тылы, где меня и другого уцелевшего положат в военнй госпиталь."
