...
label argun_survived:
    ...
    "Превозмогая боль я пополз искать медицину."
    ...
    "Через разбитый иллюминатор было видно рацию и искорёженное тело пилота."
    "Ему оторвало обе руки, левая нога была на месте, но наполовину отделена от тела."
    #звук рации
    ...
    "Я перевел оружие в автоматический режим и забравшись на холм, выглянул из-за него."
    ...
    "Прицелившись в боевиков, прокричал я, и кинул её."
    ...
    om "Как овцу порежу! Потроха вытрясу!"
...
label oldman_alive:
    ...
    "Дышать было тяжело, руки были ватные, сердце стучало как бешеное."
    "В этот день я чуть не погиб, и единственное что мне сейчас хотелось - чтобы он поскорее закончился."
    ...
    "Спустя полчаса отдыха лёжа на спине мне немного полегчало."
    ...
    "Действие адреналина спало и как только я наступил на раненую ногу, то сразу повалился."
    ...
    "На гул людей, окруживших меня, собрались зеваки."
    "Меня остановили возле пленного, такого же как я."
    "Руки у меня были связаны, все вещи с меня сняли, кроме майки и портков."
    "Один из чеченцев, стоящий к нам ближе всех выхватил нож из кармана и поднёс к моему горлу."
    ...
    "В период Первой чеченской кампании было убито около четырёх тысяч молодых российских солдат."
...
label oldman_dead:
    ...
    "Через пару секунд стал различим звук лопастей приближающегося вертолёта."
    ...
    "Среди звёзд был виден силуэт вертолёта, который садился метрах в трёхста от меня, отбрасывая тепловые ловушки где-то за очередным холмом."
    "Не желая оставаться здесь, я побежал в его сторону, тратя свой последний остаток сил на марш-бросок."
    ...
    "Из-за всей этой суматохи в деревне, потом из-за эйфории от спасения мой организм вырабатывал столько адреналина, что я совсем забыл что у меня в ноге не хилая дырка."
    ...
    "Мы начали взлетать. {w}В вертолёте некоторое время было молчание."
