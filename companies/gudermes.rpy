label gudermes:
    ...
    hide train_open with dissolve
    scene black with dissolve2
    ofic "{color=#262626}С Богом...{/color}"
    "Состав тронулся."
    hide black
    show train_inside with dissolve2
    ...
    "Это было прекрастное зрелище, величественные горы с редким , голубое небо с пушистыми облоками."
