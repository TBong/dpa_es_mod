...
label gudermes_day1:
    ...
    "Поля орашались солнечным светом, блестали, играли золотом. Давно я такого не видел, но все же красоты родного Урала мне больше по душе."
    "Так прошел час."
    ...
    menu:
        "Узнать":
            ...
            gen "Это исключения, а я сомниваюсь, что все мы тут такие исключительные..."
            show gen mournful
